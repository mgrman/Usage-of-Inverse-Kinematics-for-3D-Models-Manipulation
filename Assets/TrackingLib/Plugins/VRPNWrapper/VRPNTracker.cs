...
public class VRPNTracker : MonoBehaviour {
	...
	{
        return initialized && _lastReportTime > Time.unscaledTime-5;
	}
    ...
    bool StartTracker () { 	
        if (VRPNManager.initialized)
        {
            ...
            VRPNTrackerStart(TrackerName,(int)Derivation);
            num_trackers++;
	...
	{
		VRPNTrackerPosReport(TrackerName,repsPtr[0],IntPtr.Zero,SensorNumber);
